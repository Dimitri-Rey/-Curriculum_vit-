...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Initialiser fadeElements
    fadeElements = Array.from(document.querySelectorAll(".fade-in"));
    ...
    // Ajouter l'event listener pour le scroll seulement si des éléments fade-in existent
...
function smoothScroll(target) {
  ...
  function animation(currentTime) {
    ...
    const run = ease(timeElapsed, start, distance, 500);
...
// Optimisation des event listeners avec la délégation
document.addEventListener('click', (e) => {
