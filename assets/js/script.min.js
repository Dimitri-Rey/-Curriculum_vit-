...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Désactiver le défilement pendant le captcha
    document.body.style.overflow = 'hidden';
    // Cacher le contenu principal initialement
...
function startGeneration() {
    // Attendre un peu avant de cacher le terminal
    setTimeout(() => {
        const terminalLoader = document.querySelector('.terminal-loader');
        if (terminalLoader) {
            terminalLoader.classList.add('hidden');
            // S'assurer que le scroll est réinitialisé
            window.scrollTo(0, 0);
            // Activer le défilement sur le body
